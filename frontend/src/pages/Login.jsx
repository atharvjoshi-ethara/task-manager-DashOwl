        ...
        <div className="grid min-h-[calc(100vh-4rem)] grid-cols-1 lg:grid-cols-[1fr_1fr] bg-surface text-textMain dark:bg-surface dark:text-textMain">
          <div className="bg-gradient-to-br from-[#1d4ed8] via-[#2563eb] to-[#1e40af] p-10 sm:p-12 lg:p-16 text-white flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-sm leading-7 text-white/75">
                A modern workspace for teams and tasks. Sign in to continue your journey and access your dashboard with confidence.
              </p>
          ...
          <div className="p-8 sm:p-12 lg:p-14 bg-surface text-textMain dark:bg-surface dark:text-textMain">
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="max-w-md mx-auto">
              <div className="mb-8">
                <h1 className="text-3xl font-semibold text-textMain dark:text-textMain">Sign in</h1>
                <p className="mt-3 text-sm text-textMuted dark:text-textMuted">Welcome back! Enter your details to continue.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full rounded-3xl bg-primary py-4 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-50"
                >
